...
globals [
  average-similarity ;; avr proportion of similar neighbors
  unhappiness ;; proportion of the unhappy agents
]
...
to go
  if all? households [ happy? ] [stop]
  move-unhappy-households
  update-households
  update-globals
  tick
end
...
to update-globals
  let similar-neighbors sum [prop-similar-neighbors] of households
  set average-similarity (similar-neighbors / count households)
  set unhappiness (count households with [not happy?] / count households)
end
...
"" ""
PENS
"default" 1.0 0 -5298144 true "" "plot unhappiness"
...
"" ""
PENS
"default" 1.0 0 -12087248 true "" "plot average-similarity"
